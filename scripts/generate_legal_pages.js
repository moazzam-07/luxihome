...
<nav class="grid grid-cols-[1fr_1fr] sm:grid-cols-[1fr_auto_1fr] items-center absolute top-0 right-0 left-0 pt-20 lg:pt-40 pl-40 pr-20 sm:px-20 lg:px-40 pointer-events-none z-50" data-target="header-menu">
    ...
    <div class="order-2 luxi-header-logo flex justify-start lg:justify-center items-center absolute left-20 sm:left-24 lg:left-1/2 -translate-x-0 lg:-translate-x-1/2 top-20 lg:top-20 z-40" data-target="header-menu">
        <a href="/" data-target="menu-logo" data-theme="light" class="group pointer-events-auto block w-fit h-fit" title="LUXiHOME" data-barba-prevent="self">
            <div class="relative w-[160px] sm:w-[210px] lg:w-[260px] h-auto transition-opacity duration-300 ease-linear opacity-100 visible will-change-[opacity]" data-target="logo-lottie" data-played="true" title="LUXiHOME">
                <svg width="260" height="84" viewBox="105 40 1010 325" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[160px] sm:w-[210px] lg:w-[260px] h-auto block mx-auto">
    ...
    <main id="main" class="pt-140 sm:pt-170 lg:pt-190 px-20 sm:px-30 lg:px-60 max-w-[1240px] mx-auto">
        ...
        <header class="mb-50 lg:mb-80 max-w-[900px]">
            <div class="inline-flex items-center gap-10 legal-pill px-16 py-6 rounded-full text-11 tracking-1 uppercase mb-20">
                ...
                <span>Legal Atelier • LUXiHOME Pvt. Ltd.</span>
            </div>
            ...
            <div class="mt-25 flex flex-wrap items-center gap-20 text-13 tracking-0.4 text-white/40">
                ...
                <span>•</span>
                <span>Jurisdiction: Kolkata, West Bengal &amp; Dubai, UAE</span>
                <span>•</span>
        ...
        <div class="legal-card p-24 sm:p-35 mb-60 border-l-4 border-l-[#C2A26A]">
            <h3 class="legal-kicker text-13 uppercase text-[#C2A26A] tracking-1.2 mb-10">Atelier Engagement Summary</h3>
            <p class="font-body text-14 sm:text-15 text-white/80 leading-relaxed mb-0">
                At LUXiHOME, every residential and penthouse project is a bespoke architectural journey. By accessing our services, scheduling site consultations, or signing an architectural execution contract, you enter into a binding agreement with LUXiHOME Pvt. Ltd. Our obligations guarantee turnkey accountability, strict non-disclosure of private residences, and uncompromising material integrity backed by a 10-year craftsmanship warranty.
            </p>
        </div>
        ...
        <div class="space-y-40 sm:space-y-50">
            ...
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    ...
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Atelier Scope &amp; Bespoke Commissions</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        1.1. <strong class="text-white">Turnkey Mandate:</strong> LUXiHOME Pvt. Ltd. operates as a full-spectrum architecture and interior atelier. All commissions encompass architectural space planning, 3D structural and photorealistic visualizations, civil shell modifications, custom millwork, curated lighting layouts, and fine furniture staging.
                    </p>
                    <p>
                        1.2. <strong class="text-white">Consultation &amp; Feasibility:</strong> Initial design consultations and site appraisals in Kolkata (including Ballygunge, Alipore, New Town, Salt Lake, and Park Street) or Dubai are scheduled following the receipt of architectural floor plans and spatial briefs. Site visits verify structural viability, MEP infrastructure, and load-bearing constraints.
                    </p>
                    <p>
                        1.3. <strong class="text-white">Mutual Agreement:</strong> Detailed architectural scopes, itemized Bills of Quantities (BOQ), and project schedules become binding only upon mutual execution of the Project Charter and receipt of the initial mobilization deposit.
                    </p>
                </div>
            </article>

            <!-- 02. Architectural Concepts & IP -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">02</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Intellectual Property &amp; Blueprint Ownership</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        2.1. <strong class="text-white">Proprietary Atelier Designs:</strong> All concept drawings, 3D architectural renderings, CAD schematics, bespoke furniture joinery details, and spatial blueprints produced by LUXiHOME Pvt. Ltd. remain the exclusive intellectual property of LUXiHOME.
                    </p>
                    <p>
                        2.2. <strong class="text-white">Client License:</strong> Upon full project settlement, the client is granted an irrevocable, perpetual, exclusive license to inhabit and utilize the physical execution within the designated estate. Drawings may not be reproduced, modified, or transferred to third-party contractors without explicit written authorization from our lead architect.
                    </p>
                </div>
            </article>

            <!-- 03. Milestone Payment Framework -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">03</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Turnkey Milestone Payment Architecture</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        3.1. <strong class="text-white">Structured Milestone Disbursements:</strong> Payments are structured strictly around verified progress milestones to ensure total financial transparency:
                    </p>
                    <ul class="list-disc pl-25 space-y-8 text-white/70">
                        <li><strong class="text-white">Stage 1 (Mobilization &amp; 3D Finalization):</strong> Site survey, comprehensive architectural renders, material sample approvals, and procurement scheduling.</li>
                        <li><strong class="text-white">Stage 2 (Civil &amp; MEP Shell Execution):</strong> Electrical conduit layout, plumbing realignment, HVAC ducting, and gypsum framing.</li>
                        <li><strong class="text-white">Stage 3 (Carpentry &amp; Millwork Fabrication):</strong> BWP marine-ply structural carcass, veneer pressing, and custom modular carcass installations.</li>
                        <li><strong class="text-white">Stage 4 (Finishing, Italian Marble &amp; Hardware):</strong> Marble laying, polyurethane (PU) coat applications, architectural lighting fixtures, and sanitary fitments.</li>
                        <li><strong class="text-white">Stage 5 (White-Glove Handover):</strong> Deep detailing, soft furnishings, defect inspection walkthrough, and official key handover.</li>
                    </ul>
                    <p>
                        3.2. <strong class="text-white">Disbursement Integrity:</strong> Materials are procured and reserved exclusively upon receipt of each corresponding milestone tranche. Work progresses seamlessly in parallel with confirmed schedule releases.
                    </p>
                </div>
            </article>

            <!-- 04. Materials & Procurement -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">04</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Material Specifications &amp; Quality Sourcing</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        4.1. <strong class="text-white">Direct Sourcing:</strong> All exotic Italian marbles, kiln-dried natural hardwoods, solid brass hardware, and specialized architectural veneers are inspected directly at origin quarries and master mills.
                    </p>
                    <p>
                        4.2. <strong class="text-white">Natural Variations:</strong> Natural stone, genuine timber grain, and hand-applied patinas inherently possess unique veining, color graduations, and surface textures. These natural characteristics attest to the authenticity of organic luxury materials and are celebrated as unique design features rather than defects.
                    </p>
                </div>
            </article>

            <!-- 05. Craftsmanship Warranty -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">05</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">10-Year Craftsmanship &amp; Structural Warranty</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        5.1. <strong class="text-white">Warranty Coverage:</strong> LUXiHOME provides an industry-leading 10-year warranty covering custom joinery structural integrity, termite-resistant substrate marine carcasses, concealed MEP junctions, and precision architectural hardware mechanisms installed by our authorized master craftsmen.
                    </p>
                    <p>
                        5.2. <strong class="text-white">Maintenance &amp; Care:</strong> Normal wear and tear, direct water flooding from unsealed external building facades, or unauthorized structural tampering by external technicians will void warranty provisions. Our concierge desk provides complimentary bi-annual inspection visits during the initial 24 months of occupancy.
                    </p>
                </div>
            </article>

            <!-- 06. Client Discretion & Non-Disclosure -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">06</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Confidentiality, Site Security &amp; Discretion</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        6.1. <strong class="text-white">Client Discretion Protocol:</strong> LUXiHOME caters to distinguished families, corporate leaders, and high-net-worth estate owners. We enforce strict Non-Disclosure Agreements (NDAs) across all internal architects, project managers, and artisan crews.
                    </p>
                    <p>
                        6.2. <strong class="text-white">Private Estate Protection:</strong> Client identities, exact residential addresses, private biometric security schematics, and vault locations are never disclosed, broadcast, or published. Photography for design publications is strictly subject to prior written client consent with complete anonymity.
                    </p>
                </div>
            </article>

            <!-- 07. Dispute Resolution & Governing Law -->
            <article class="legal-card p-30 sm:p-45">
                <div class="flex items-center gap-15 mb-20">
                    <span class="text-24 sm:text-30 font-light text-[#C2A26A] font-sans">07</span>
                    <h2 class="text-20 sm:text-26 font-normal uppercase tracking-0.8 text-white">Governing Law &amp; Atelier Jurisdiction</h2>
                </div>
                <div class="space-y-16 font-body text-15 sm:text-16 text-white/75 leading-relaxed">
                    <p>
                        7.1. <strong class="text-white">Legal Jurisdiction:</strong> These Terms and Conditions and any commissions undertaken in India shall be governed by and construed in accordance with the laws of India. Courts situated in Kolkata, West Bengal shall have exclusive jurisdiction over any disputes arising hereunder.
                    </p>
                    <p>
                        7.2. <strong class="text-white">International Commissions:</strong> For projects commissioned through our Dubai liaison desk or involving UAE properties, international arbitration clauses under the Dubai International Arbitration Centre (DIAC) rules apply where designated in the specific project schedule.
                    </p>
                </div>
            </article>
        ...
        <div class="mt-70 p-35 sm:p-50 rounded-24 bg-gradient-to-r from-[#172A3A] to-[#101C27] border border-[#C2A26A]/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-30">
            <div>
                <p class="legal-kicker text-12 text-[#C2A26A] uppercase mb-8">Direct Atelier Legal Concierge</p>
                <h3 class="text-22 sm:text-28 font-light text-white uppercase tracking-0.8 mb-10">Have questions regarding our terms?</h3>
                <p class="text-14 text-white/60 max-w-[550px] mb-0">
                    Our lead architectural partners and legal counsel are at your disposal to review bespoke contract addendums or customize private estate non-disclosure provisions.
                </p>
            </div>
            <div class="flex flex-col sm:flex-row items-center gap-15">
                ...
                <a href="mailto:concierge@luxihome.com" class="inline-flex items-center justify-center px-24 py-14 rounded-full border border-white/20 text-white font-normal text-13 tracking-1 uppercase hover:border-[#C2A26A] hover:text-[#C2A26A] transition-colors duration-200">
                    concierge@luxihome.com
                </a>
            </div>
        </div>
